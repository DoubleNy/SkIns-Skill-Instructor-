...
function setTemplate3() {
  document.documentElement.style.setProperty('--color1','var(--T3color1)');
  document.documentElement.style.setProperty('--color2','var(--T3color2)');
  document.documentElement.style.setProperty('--color3','var(--T3color3)');
  document.documentElement.style.setProperty('--color4','var(--T3color4)');
  document.documentElement.style.setProperty('--color5','var(--T3color5)');
}

function setTemplate4() {
  document.documentElement.style.setProperty('--color1','var(--T4color1)');
  document.documentElement.style.setProperty('--color2','var(--T4color2)');
  document.documentElement.style.setProperty('--color3','var(--T4color3)');
  document.documentElement.style.setProperty('--color4','var(--T4color4)');
  document.documentElement.style.setProperty('--color5','var(--T4color5)');
}
