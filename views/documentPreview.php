<html>
  ...
  <head>
    ...
    <link rel="stylesheet" href="public/css/documentPreview.css">
...
<!--    <script src="../javascript/slideshow.js"></script>-->
  ...
  <body>
      ...
      <div class="infoDocument" style="margin-top:0px;">
        <div class="documentTitle">
          <h1>Title of the document</h1>
        </div>
        <div class="imageBox" style="background:url('../images/docpic1.jpg');background-position: -100px 150px;">
        </div>
      </div>

      <div class="infoDocument2">
        <div class="imageBox" style="background:url('../images/docpic2.jpg');background-position: -100px -150px;">
        </div>
      ...
      <div class="infoDocument">
        ...
        <div class="imageBox" style="background:url('../images/docpic3.jpg');background-position: -100px 150px;">
        </div>
      </div>
      ...
      <script src="public/javascript/template.js"></script>
